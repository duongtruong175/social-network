package vn.hust.socialnetwork.ui.proposegroup.adapters;
...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.GroupViewHolder> {
    ...
    public GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_propose_group, parent, false);
    ...
    public class GroupViewHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatTextView tvGroupName, tvGroupMemberCount, tvJoinGroup;
        LinearLayoutCompat lName;
        ...
        public GroupViewHolder(@NonNull View itemView) {
            ...
            tvJoinGroup = itemView.findViewById(R.id.tv_join_group);
            ...
            if (onGroupListener != null) {
                tvJoinGroup.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        onGroupListener.onJoinGroupClick(getBindingAdapterPosition());
                    }
                });

                ivGroupCover.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
