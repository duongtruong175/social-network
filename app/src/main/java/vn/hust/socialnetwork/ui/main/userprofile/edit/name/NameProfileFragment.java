package vn.hust.socialnetwork.ui.main.userprofile.edit.name;
...
import vn.hust.socialnetwork.ui.authentication.forgotpassword.ForgotPasswordFragment;
...
public class NameProfileFragment extends Fragment {
    ...
    private AppCompatTextView tvToolbarTitle, tvToolbarConfirm, tvErrorName;
    private LinearProgressIndicator pbLoading;
    private TextInputLayout lEdit;
    private TextInputEditText etName;

    public NameProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_name_profile, container, false);
        ...
        // init view
        tvToolbarTitle.setText(R.string.toolbar_title_edit_name);
        ...
        ivToolbarBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NavController navController = NavHostFragment.findNavController(NameProfileFragment.this);
    ...
    private void updateUser() {
        ContextExtension.hideKeyboard(etName);
            ...
            call.enqueue(new Callback<BaseResponse<User>>() {
                ...
                public void onResponse(Call<BaseResponse<User>> call, Response<BaseResponse<User>> response) {
                    if (response.isSuccessful()) {
                        Toast.makeText(getContext(), R.string.update_name_success, Toast.LENGTH_SHORT).show();
                        // update user
                        user.setName(name);
